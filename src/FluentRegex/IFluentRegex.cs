...
public interface IFluentRegex : IOutputTypes
{
    /// <summary>
    ...
    /// </summary>
    FluentRegex MatchFromBeginningOfInput(string match);

    /// <summary>
    /// Use this if you want to create a more complex regex query
    /// Matches the beginning of input. For example, /^A/ does not match the "A" in "an A", but does match the first "A" in "An A".
    /// </summary>
    FluentRegex MatchFromBeginningOfInput(Func<FluentRegex, FluentRegex> func);
    ...
    /// </summary>
    FluentRegex MatchFromEndOfInput(string match);
    FluentRegex MatchFromEndOfInput(Func<FluentRegex, FluentRegex> func);

    /// <summary>
    /// Matches any single character except a newline character.
    ///</summary>
    FluentRegex MatchSingleCharacter(char characher);

    /// <summary>
    /// Matches a digit character. Equivalent to [0-9].
    /// </summary>
    FluentRegex MatchDigit();
    ...
    /// </summary>
    FluentRegex MatchNoneCharacter();
    ...
    /// </summary>
    FluentRegex MatchCharacterSet(string sequence);
    ...
    /// </summary>
    FluentRegex MatchNegativeCharacterSet(string sequence);
    ...
    /// </summary>
    FluentRegex MatchExactNCharInstance(string sequence, uint instance);
    ...
    /// </summary>
    FluentRegex MatchAtLeastNCharInstance(string sequence, uint instance);
    ...
    /// </summary>
    FluentRegex MatchInRangeCharInstanc(string sequence, uint start, uint max);

    /// <summary>
    /// Matches the input string exactly
    /// </summary>
    FluentRegex MatchWord(string word);
    ...
    /// </summary>
    FluentRegex EscapeChar(char character);

    /// <summary>
    /// Matches a single white space character, including space, tab, form feed, line feed, and other Unicode spaces. Equivalent to [ \f\n\r\t\v\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]. For example, /\s\w*/ matches " bar" in "foo bar".
    /// </summary>
    FluentRegex MatchSingleWhitespace();

    /// <summary>
    /// Matches a single character other than white space. Equivalent to [^ \f\n\r\t\v\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]. For example, /\S\w*/ matches "foo" in "foo bar".
    /// </summary>
    FluentRegex MatchNoneWhitespace();

    /// <summary>
    /// Matches a horizontal tab.
    /// </summary>
    FluentRegex MatchTab();

    /// <summary>
    /// Matches a carriage return.
    /// </summary>
    FluentRegex MatchCarriageReturn();

    /// <summary>
    /// Matches a linefeed.
    /// </summary>
    FluentRegex MatchLineFeed();

    /// <summary>
    /// Matches a vertical tab.
    /// </summary>
    FluentRegex MatchVerticalTab();

    /// <summary>
    /// Matches a form-feed.
    /// </summary>
    FluentRegex MatchFormFeed();

    /// <summary>
    /// Matches a backspace. If you're looking for the word-boundary character (\b)
    /// </summary>
    FluentRegex MatchBackspace();

    /// <summary>
    /// Matches a NUL character. Do not follow this with another digit.
    /// </summary>
    FluentRegex MatchNullCharacter();
    ...
    /// </summary>
    FluentRegex MatchControlCharacter(char character);

    /// <summary>
    /// Matches the character with the code hh (two hexadecimal digits).
    /// </summary>
    FluentRegex MatchHexidecimalCharacter(string hexcode);

    /// <summary>
    /// Matches a UTF-16 code-unit with the value hhhh (four hexadecimal digits).
    /// </summary>
    FluentRegex MatchUTF16Character(string hexcode);
    ...
    /// </summary>
    FluentRegex MatchLookAheadAssertion(string x, string y);
    ...
    /// </summary>
    FluentRegex MatchNagativeLookAheadAssertion(string x, string y);
    ...
    /// </summary>
    FluentRegex MatchLookBehindAssertion(string x, string y);
    ...
    /// </summary>
    FluentRegex MatchNegativeLookBehindAssertion(string x, string y);

    /// <summary>
    /// Matches either "x" or "y". For example, /green|red/ matches "green" in "green apple" and "red" in "red apple".
    /// </summary>
    FluentRegex MatchWithOr(string x, string y);
    ...
    /// </summary>
    ISubExpression AddSubexpression(Func<FluentRegex, FluentRegex> pattern);
}
